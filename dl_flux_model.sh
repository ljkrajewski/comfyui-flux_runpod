...
wget -c https://huggingface.co/lllyasviel/flux1-dev-bnb-nf4/resolve/main/flux1-dev-bnb-nf4.safetensors --header="Authorization: Bearer $HF_TOKEN" -P ./models/checkpoints/
